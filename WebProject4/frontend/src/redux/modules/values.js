...
const ENTER_R = 'webproject4/values/ENTER_R';
const ENTER_X = 'webproject4/values/ENTER_X';
const ENTER_Y = 'webproject4/values/ENTER_Y';
const CLEAR_CURRENT = 'webproject4/values/CLEAR_CURRENT';
